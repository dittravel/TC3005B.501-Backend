...
async function seedDummyTravelFixtures() {
  ...
  const requestsData = [
    { notes: 'Solicito viaticos para viaje a conferencia en Barcelona.', requested_fee: 1500.0, imposed_fee: null, request_days: 3.0, status: 'Borrador', assigned_to: null, authorization_rule_id: 1 },
    { notes: 'Reembolso por gastos medicos durante viaje.', requested_fee: 800.0, imposed_fee: null, request_days: 1.0, status: 'Revision', assigned_to: authorizer.user_id, authorization_rule_id: 1 },
    { notes: 'Solicitud de apoyo economico para capacitacion online.', requested_fee: 500.0, imposed_fee: null, request_days: 0.0, status: 'Cotizacion del Viaje', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
    { notes: 'Viaticos para taller de liderazgo en Madrid.', requested_fee: 1200.0, imposed_fee: null, request_days: 2.0, status: 'Atencion Agencia de Viajes', assigned_to: agency.user_id, authorization_rule_id: 1 },
    { notes: 'Reembolso de transporte.', requested_fee: 300.0, imposed_fee: 250.0, request_days: 0.5, status: 'Comprobacion gastos del viaje', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
    { notes: 'Apoyo para participacion en congreso internacional.', requested_fee: 2000.0, imposed_fee: 1800.0, request_days: 4.0, status: 'Validacion de comprobantes', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
    { notes: 'Gastos operativos extraordinarios.', requested_fee: 650.0, imposed_fee: 600.0, request_days: 0.0, status: 'Finalizado', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
    { notes: 'Viaje urgente por representacion institucional.', requested_fee: 1750.0, imposed_fee: 1500.0, request_days: 3.5, status: 'Cancelado', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
    { notes: 'Solicito anticipo para mision tecnica en el extranjero.', requested_fee: 2200.0, imposed_fee: 2000.0, request_days: 5.0, status: 'Rechazado', assigned_to: accountsPayable.user_id, authorization_rule_id: 1 },
  ];
